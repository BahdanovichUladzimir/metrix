        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="input-sum">
                        <?php echo CHtml::hiddenField("LMI_PAYMENT_NO",$webmoneyModel->id); ?>
                        <?php echo CHtml::hiddenField("LMI_PAYMENT_DESC_BASE64",base64_encode($webmoneyModel->description)); ?>
                        <?php echo CHtml::hiddenField("LMI_PAYEE_PURSE",$webmoneyModel->purse); ?>
