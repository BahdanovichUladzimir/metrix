<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dir_path')); ?>:</b>
	<?php echo CHtml::encode($data->dir_path); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('dir_url')); ?>:</b>
	<?php echo CHtml::encode($data->dir_url); ?>
	<br />
