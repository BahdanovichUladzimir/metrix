...
*/
;?>
<?php if( Yii::app()->user->hasFlash('dealsmodule.backend.rating.create.success')):?>
    <div class="alert alert-success alert-dismissible" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <?php echo Yii::app()->user->getFlash('dealsmodule.backend.rating.create.success'); ?>
    </div>
<?php endif; ?>

<?php if( Yii::app()->user->hasFlash('dealsmodule.backend.rating.create.error')):?>
    <div class="alert alert-danger alert-dismissible" role="alert">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <?php echo Yii::app()->user->getFlash('dealsmodule.backend.rating.create.error'); ?>
    </div>
<?php endif; ?>
