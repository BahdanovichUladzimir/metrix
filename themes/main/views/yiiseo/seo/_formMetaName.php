<fieldset>
    ...
    <div class="form-group">
        ...
        <?php if($model->name == "keywords"){?>
            <?php echo CHtml::activeTextField($model,"[$model->name]content",array("size"=>60,"id"=>"tags", 'class' => 'form-control')); ?>
        <?php } else {?>
            <?php echo CHtml::activeTextField($model,"[$model->name]content",array("size"=>60, 'class' => 'form-control')); ?>
        <?php }?>
