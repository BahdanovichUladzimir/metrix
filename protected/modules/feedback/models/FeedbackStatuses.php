...
/**
 * This is the model class for table "FeedbackStatuses".
 *
 * The followings are the available columns in table 'FeedbackStatuses':
 * @property string $id
 ...
 */
class FeedbackStatuses extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'feedbacks' => array(self::HAS_MANY, 'Feedback', 'status_id'),
		);
	}
	 ...
	 * @return FeedbackStatuses the static model class
	 */
