 ...
 * @property boolean $vkPublished
 * @property boolean $fbPublished
...
class CmsPage extends CmsNode {
    ...
    public function getAbsoluteUrl($params = array()) {
        return Yii::app()->createAbsoluteUrl('cms/page/view', CMap::mergeArray($params, array('id' => $this->id, 'name' => $this->urlAlias)));
    }
    ...
    public function getParentOptionTree() {
        ...
        $options = array('0' => Yii::t('page', 'No parent'));
    ...
    protected function renderBranch($branch) {
        echo '<li>';
        echo CHtml::link($branch['model']->content->heading, Yii::app()->cms->createUrl($branch['model']->name));
    ...
    public function getTypeOptions() {
        return CMap::mergeArray(array('' => Yii::t('page', 'None')), Yii::app()->controller->module->pageTypes);
    }
    ...
    public function scopes() {
        return array(
            'published' => array(
                'condition' => 't.published = 1 and t.type in ("0","2")',
            //'limit'=>1,
            ),
        );
    }
    ...
    /* public function beforeSave(){
      ...
      if($this->type==2){
      $event= new Event;
      $event->findByAttributes(array('pageId'=>$this->id));
      }
      parent::beforeDelete();
      return true;
      } */
