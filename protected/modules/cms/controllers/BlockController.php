...
class BlockController extends NodeController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['CmsBlock'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash($this->module->flashes['success'], Yii::t('block', 'Block created.'));
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['CmsBlock'], $_POST['CmsBlockContent'])) {
            ...
            if ($valid) {
                ...
                Yii::app()->user->setFlash($this->module->flashes['success'], Yii::t('block', 'Block updated.'));
    ...
    public function actionDelete($id) {
        ...
        Yii::app()->user->setFlash($this->module->flashes['success'], Yii::t('block', 'Block deleted.'));
