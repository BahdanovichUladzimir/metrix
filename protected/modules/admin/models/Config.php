...
class Config extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'param' => Yii::t('adminModule', 'Param'),
			'value' => Yii::t('adminModule', 'Value'),
			'default' => Yii::t('adminModule', 'Default'),
			'label' => Yii::t('adminModule', 'Label'),
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>100, //could put 1, 2, 3, 10, 20, 30, etc. however many you want to display per page.
			),
