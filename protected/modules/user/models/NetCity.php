 ...
 */
class NetCity extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, country_id, name_ru, name_en, region, postal_code, latitude, longitude', 'safe', 'on'=>'search'),
		);
	}
	...
	public static function getListData(){
		...
		return CHtml::listData(self::model()->findAll($criteria),'id','name_ru');
	}
}
