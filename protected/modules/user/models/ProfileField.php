...
class ProfileField extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('varname', 'match', 'pattern' => '/^[A-Za-z_0-9]+$/u','message' => Yii::t('userModule',"Variable name may consist of A-z, 0-9, underscores, begin with a letter.")),
			array('varname', 'unique', 'message' => Yii::t('userModule',"This field already exists.")),
	...
	public function attributeLabels()
	{
		return array(
			...
			'varname' => Yii::t('userModule','Variable name'),
			'title' => Yii::t('userModule','Title'),
			'field_type' => Yii::t('userModule','Field Type'),
			'field_size' => Yii::t('userModule','Field Size'),
			'field_size_min' => Yii::t('userModule','Field Size min'),
			'required' => Yii::t('userModule','Required'),
			'match' => Yii::t('userModule','Match'),
			'range' => Yii::t('userModule','Range'),
			'error_message' => Yii::t('userModule','Error Message'),
			'other_validator' => Yii::t('userModule','Other Validator'),
			'default' => Yii::t('userModule','Default'),
			'widget' => Yii::t('userModule','Widget'),
			'widgetparams' => Yii::t('userModule','Widget parametrs'),
			'position' => Yii::t('userModule','Position'),
			'visible' => Yii::t('userModule','Visible'),
		);
	}
	...
	public static function itemAlias($type,$code=NULL) {
		$_items = array(
			'field_type' => array(
				'INTEGER' => Yii::t('userModule','INTEGER'),
				'VARCHAR' => Yii::t('userModule','VARCHAR'),
				'TEXT'=> Yii::t('userModule','TEXT'),
				'DATE'=> Yii::t('userModule','DATE'),
				'FLOAT'=> Yii::t('userModule','FLOAT'),
				'DECIMAL'=> Yii::t('userModule','DECIMAL'),
				'BOOL'=> Yii::t('userModule','BOOL'),
				'BLOB'=> Yii::t('userModule','BLOB'),
				'BINARY'=> Yii::t('userModule','BINARY'),
			),
			'required' => array(
				self::REQUIRED_NO => Yii::t('userModule','No'),
				self::REQUIRED_NO_SHOW_REG => Yii::t('userModule','No, but show on registration form'),
				self::REQUIRED_YES_SHOW_REG => Yii::t('userModule','Yes and show on registration form'),
				self::REQUIRED_YES_NOT_SHOW_REG => Yii::t('userModule','Yes'),
			),
			'visible' => array(
				self::VISIBLE_ALL => Yii::t('userModule','For all'),
				self::VISIBLE_REGISTER_USER => Yii::t('userModule','Registered users'),
				self::VISIBLE_ONLY_OWNER => Yii::t('userModule','Only owner'),
				self::VISIBLE_NO => Yii::t('userModule','Hidden'),
			),
		);
		if (isset($code))
