...
class UHtml extends CHtml
{
    public static function activeTimeField($model,$attribute,$htmlOptions=array())
    {
                ...
                $monthOptions = array(
					'0' => ' - ',
					'1'=> Yii::t('userModule','January'),
					'2'=> Yii::t('userModule','February'),
					'3'=> Yii::t('userModule','March'),
					'4'=> Yii::t('userModule','April'),
					'5'=> Yii::t('userModule','May'),
					'6'=> Yii::t('userModule','June'),
					'7'=> Yii::t('userModule','July'),
					'8'=> Yii::t('userModule','August'),
					'9'=> Yii::t('userModule','September'),
					'10'=> Yii::t('userModule','October'),
					'11'=> Yii::t('userModule','November'),
					'12'=> Yii::t('userModule','December'),
                );
	...
	public static function activeDateField($model,$attribute,$htmlOptions=array())
    {
                ...
                $monthOptions = array(
					'00' => ' - ',
					'01'=> Yii::t('userModule','January'),
					'02'=> Yii::t('userModule','February'),
					'03'=> Yii::t('userModule','March'),
					'04'=> Yii::t('userModule','April'),
					'05'=> Yii::t('userModule','May'),
					'06'=> Yii::t('userModule','June'),
					'07'=> Yii::t('userModule','July'),
					'08'=> Yii::t('userModule','August'),
					'09'=> Yii::t('userModule','September'),
					'10'=> Yii::t('userModule','October'),
					'11'=> Yii::t('userModule','November'),
					'12'=> Yii::t('userModule','December'),
                );
