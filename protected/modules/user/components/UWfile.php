...
class UWfile {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>Yii::t('userModule','File field'),
			'fieldType'=>array('VARCHAR'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'path'=>Yii::t('userModule','Upload path'),
			),
	...
	public function editAttribute($model,$field,$params=array()) {
		...
		.' '.CHtml::activeLabelEx($model,'[uwfdel]'.$field->varname,array('label'=>Yii::t('userModule','Delete file'),'style'=>'display:inline;')):'')
		;
	}
