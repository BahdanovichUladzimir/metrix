...
class UWjuiAutoComplete {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>Yii::t('userModule','jQueryUI autocomplete',array(),__CLASS__),
			'fieldType'=>array('INTEGER'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'modelName'=>Yii::t('userModule','Model Name',array(),__CLASS__),
				'optionName'=>Yii::t('userModule','Lable field name',array(),__CLASS__),
				'emptyFieldLabel'=>Yii::t('userModule','Empty item name',array(),__CLASS__),
				'emptyFieldValue'=>Yii::t('userModule','Empty item value',array(),__CLASS__),
				'relationName'=>Yii::t('userModule','Profile model relation name',array(),__CLASS__),
				'minLength'=>Yii::t('userModule','minimal start research length',array(),__CLASS__),
			),
		);
	}
